...
class SiliconeViewController: UITableViewController, productPageDelegate {
    var image: UIImage?
    var name: String?
    var price: Double?
    var products: [Straw] =
        [Straw(image: #imageLiteral(resourceName: "siliconestrawwithbox"), name: "Silicone Straw (With Box)", price: 11.99)]
