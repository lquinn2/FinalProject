...
class CollapsibleViewController: UITableViewController, productPageDelegate {
    var image: UIImage?
    var name: String?
    var price: Double?
    var products: [Straw] =
        [Straw(image: #imageLiteral(resourceName: "collapsible"), name: "Collapsible Straw (With Bin)", price: 19.99)]
